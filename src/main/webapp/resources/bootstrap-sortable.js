...
!function (a, b) {
    ...
    function a(a, f) {
        ...
        function s(a) {
            var b = !!a.selector, c = b && ":" === a.selector[0], d = e(a || {}, r);
            D.push(e({
                hasSelector: b,
        ...
        function t() {
            d(a, function (a, b) {
                ...
                var c = D[0], d = c.hasFilter, e = c.selector, f = !e || d && a.matchesSelector(e) || e && a.querySelector(e), g = f ? B : C, h = {
                    elm: a,
                    pos: b,
                    posn: g.length
                };
        ...
        function v(a, e) {
            var f = 0;
            for (0 !== q && (q = 0); 0 === f && p > q;) {
                var i = D[q], j = i.ignoreDashes ? n : m;
                if (d(o, function (a) {
                        var b = a.prepare;
                        b && b(i)
                    ...
                    if (r === s) f = 0; else if (i.emptyEnd && (t || u)) f = t && u ? 0 : t ? 1 : -1; else {
                        if (!i.forceStrings) {
                            var v = c(r) ? r && r.match(j) : h, w = c(s) ? s && s.match(j) : h;
                            if (v && w) {
                                var x = r.substr(0, r.length - v[0].length), y = s.substr(0, s.length - w[0].length);
        ...
        var x, y, z = k.createDocumentFragment(), A = [], B = [], C = [], D = [], E = !0, F = a.length && (f === g || f.useFlex !== !1) && -1 !== getComputedStyle(a[0].parentNode, null).display.indexOf("flex");
    ...
    var g, h = !1, i = null, j = window, k = j.document, l = parseFloat, m = /(-?\d+\.?\d*)\s*$/g, n = /(\d+\.?\d*)\s*$/g, o = [], p = 0, q = 0, r = {
        selector: i,
        order: "asc",
        attr: i,
        data: i,
